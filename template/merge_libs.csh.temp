...
set IPmerge_list	= <<IPmerge_list>>
set merged_file		= <<merged_file>>
set merge_mode      = <<merge_mode>>
set timestamp		= <<timestamp>> 
cd $work_dir
setenv MGC_CWB_TEMP_DIR $work_dir
calibredrv -a layout filemerge -in $input_design -in $IPmerge_list -out $merged_file -topcell $topcell -mode $merge_mode -reportconflicts |& tee -i calibre_merge_libs_$timestamp.log 
